<template>
	<v-col class="r-c">
		<v-col class="faqs">
			<div class="p-img" data-aos="flip-left" data-aos-duration="1000">
				<p>FAQS</p>
				<img src="../assets/img/section4/p.png" alt="pessoa viajando  " />
			</div>

			<v-col class="faqs-list" data-aos="flip-right">
				<div class="faq">
					<p>
		...
		<div class="comments">
			<div class="text" data-aos="flip-left" data-aos-duration="1500">
				<div class="title">
					<h1>Let’s hear What they say</h1>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus vel
						lobortis tincidunt fames quisque
					</p>
				</div>

				<div class="buttons">
					<div @click="carouselModel--" class="left">
						<v-icon>mdi-arrow-left</v-icon>
					</div>
					<div @click="carouselModel++" class="right"><v-icon>mdi-arrow-right</v-icon></div>
				</div>
			</div>
			<v-carousel
			...
			>
				<v-carousel-item v-for="(color, i) in colors" :key="color">
					<div class="slide" data-aos="flip-right" data-aos-duration="1500">
						<img
							src="../assets/img/section4/aspas.png"
							class="left"
							alt="Aspas"
						/>
						<img
							src="../assets/img/section4/fecha-aspas.png"
							class="right"
							alt="Aspas"
						/>
						<div class="texts">
							<h2>Excellent Provide service in here</h2>
							<p>
								{{ i + 1 }}
							...
							<div class="author">
								<div
									class="img-rounded"
									:style="{ 'background-image': `url(${author})` }"
								></div>
								<div class="name-prof">
									<p class="name">Salim Russel</p>
									<p class="prof">
										Executive Diretor Presidente Super Hero
									</p>
								</div>
							</div>
						</div>
